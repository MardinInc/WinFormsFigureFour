...
namespace WinFormsFigure
{
    public partial class FormFigure : Form
    {
        ...
        private void takePen()
        {
            ...
            {
                MessageBox.Show("Incorrect pen parametrs");
                isDraw = false;
            }
        }
        ...
        {
            if (tbXcdt.Text != "X coordinate"  && tbYcdt.Text != "Y coordinate"
                && tbWdh.Text != "Width" && tbHght.Text != "Height"
            ...
            else if (tbXcdt.Text != "X coordinate" && tbYcdt.Text != "Y coordinate"
                && tbWdh.Text != "Radius" && selectFig == "Circle")
            {
                Xcdt = Convert.ToInt32(tbXcdt.Text);
                Ycdt = Convert.ToInt32(tbYcdt.Text);
                Width = Convert.ToInt32(tbWdh.Text);
                ...
                && tbWdh.Text != "X2 coordinate" && tbHght.Text != "Y2 coordinate" 
                && selectFig == "Line")
            {
                Xcdt = Convert.ToInt32(tbXcdt.Text);
                Ycdt = Convert.ToInt32(tbYcdt.Text);
            ...
            {
                MessageBox.Show("Incorrect coordinates");
            }
        }
        ...
        private void cbFigure_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                doBtn(true);
                tbxPrmt.Text = "Ending coordinate";
                tbWdh.Text = "X2 coordinate";
                tbHght.Text = "Y2 coordinate";
            }
            else if (selectFig == "")
            {
        ...
        public void doBtn(bool value)
        {
            ...
            tbXcdt.Visible = log;
            tbXcdt.Enabled = log;
            tbXcdt.Text = "X coordinate";

            tbYcdt.Visible = log;
            tbYcdt.Enabled = log;
            tbYcdt.Text = "Y coordinate";
        ...
        private void FormFigure_Shown(object sender, EventArgs e)
        {
            MessageBox.Show("Hello!\nTo start using this program, " +
                "select a shape or download a ready-made project");
        }
